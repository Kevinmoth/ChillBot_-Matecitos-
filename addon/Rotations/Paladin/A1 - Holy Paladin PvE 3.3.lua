...
local hpal_gui = {
	settingsfile = "A1 - Holy Paladin PvE3-3.json",
	{ type = "title", text = "|cfff58cbaHoly Paladin PvE |cffcece0cA1 v3.3" },
...
local function gui_load()
	ni.GUI.AddFrame("A1 Holy PvE3-3", hpal_gui)
end
local function gui_unload()
	ni.GUI.DestroyFrame("A1 Holy PvE3-3")
end
...
ni.bootstrap.profile("A1 - Holy Paladin PvE 3.3", hpal_rotation, hpal_abilities, gui_load, gui_unload)